...
class MarkdownBasedMigrationProviderTest {

	@ParameterizedTest
	@CsvSource({
			"/neo4j/markdown-migrations/initial_schema_draft.md, 2",
	...
	void shouldLoadAllMigrationsPerAdoc(String resource, int numMigrations) {
		...
		URL url = MarkdownBasedMigrationProviderTest.class.getResource(resource);
