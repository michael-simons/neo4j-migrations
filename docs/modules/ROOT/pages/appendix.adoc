...
`neo4j-migrations-{version}.jar`:: Needed to generate the catalogs
`neo4j-migrations-annotation-processor-api-{version}.jar`:: Contains the API and built-in annotations
`neo4j-migrations-annotation-processor-{version}.jar` :: The processor itself
...
----
javac -proc:only \
-processorpath neo4j-migrations-{version}.jar:neo4j-migrations-annotation-processor-api-{version}.jar:neo4j-migrations-annotation-processor-{version}.jar \
