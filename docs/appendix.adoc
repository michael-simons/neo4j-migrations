...
`ac.simons.neo4j.migrations.core.refactorings.Rename` renames labels, types and properties and requires in its default form only Neo4j 3.5 to work. Custom queries for filtering target enetities require Neo4j 4.1, batches Neo4j 4.4.
