...
Exceptions are made for callbacks (see xref:concepts.adoc#concepts_naming-conventions[naming conventions]) and some xref:extensions/index.adoc[extensions] supported by Neo4j-Migrations.
