...
/**
 * An abstract base class for Cypher based resources such as migrations and callbacks.
 *
 * @author Michael J. Simons
 * @since TBA
 */
abstract class AbstractCypherResource implements CypherResource {

	private static final Logger LOGGER = Logger.getLogger(AbstractCypherResource.class.getName());
	 ...
	 */
	protected final boolean autocrlf;
	...
	AbstractCypherResource(URL url, boolean autocrlf) {
	...
	@Override
	public String getRequiredChecksum() {
	...
	@Override
	public void executeIn(MigrationContext context) {
