 ...
 */
class OrderedCommandLineHelpTest {
	...
	void commandsShouldBeOrdered() {
		...
		OrderedCommandLineHelp orderedCommandLineHelp = new OrderedCommandLineHelp(spec, new CommandLine.Help.ColorScheme.Builder().build());

		assertThat(orderedCommandLineHelp.subcommands().keySet())
				.containsExactly("A", "B", "C");
		assertThat(orderedCommandLineHelp.allSubcommands().keySet())
			.containsExactly("A", "B", "C");
	}
}
