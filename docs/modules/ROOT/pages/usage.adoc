...
We publish the Java-API-Docs here: link:{url-apidocs}/neo4j-migrations/apidocs/index.html[Neo4j Migrations (Core) {latest_version} API].
...
[source,xml,indent=0,tabsize=2]
----
include::example$catalogbased_changesets/V010__Assert_empty_schema.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$catalogbased_changesets/V020__Create_person_name_unique.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$catalogbased_changesets/V030__Fix_person_name_constraint_CE.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$catalogbased_changesets/V030__Fix_person_name_constraint_EE.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$catalogbased_changesets/V040__Additional_stuff.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$catalogbased_changesets/V050__A_new_start.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$catalogbased_changesets/V060__Assert_final_state.xml[]
----
