...
CREATE CONSTRAINT constraint_name2 ON (n:Book) ASSERT n.isbn IS NOT NULL;
CREATE CONSTRAINT constraint_name2 IF NOT EXISTS ON (n:Book) ASSERT n.isbn IS NOT NULL;
CREATE CONSTRAINT constraint_name3 ON ()-[r:LIKED]-() ASSERT r.day IS NOT NULL;
CREATE CONSTRAINT constraint_name3 IF NOT EXISTS ON ()-[r:LIKED]-() ASSERT r.day IS NOT NULL;
