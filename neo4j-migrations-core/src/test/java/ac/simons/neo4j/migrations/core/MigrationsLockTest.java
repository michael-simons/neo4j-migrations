...
class MigrationsLockTest {
	...
	class SummaryCountersImplTest {
		...
		void containsSystemUpdatesShouldWork(int value, boolean expected) {
			...
			var counters = new MigrationsLock.SummaryCountersImpl(
				random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(),
				value);
		...
		static Stream<Arguments> containsUpdateShouldWork() {
			...
			return Stream.of(
				Arguments.of(withAPositiveValue, true),
				Arguments.of(oneUpdateOnly, true),
		...
		void containsUpdateShouldWork(int[] values, boolean expected) {
			var counters = new MigrationsLock.SummaryCountersImpl(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7], values[8], values[9], values[10], values[11]);
