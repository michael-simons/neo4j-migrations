...
`clean` applies by default to the <<concepts_separate-databases, schema database>>.
...
clean:: Cleans the selected schema database from every meta data created by this tool
...
In addition to `apply` without arguments there's also `apply` that takes in one or more refactoring. This method is only available in the Core API. Please read more about it here:  <<applying-refactorings-programmatically>>.
...
This chapter is more about conceptional usage or scenarios one can implement by using <<concepts_migrations_catalog-based, Catalog-based migrations>>.
...
[source,xml,indent=0,tabsize=2]
----
include::catalogbased_changesets/V010__Assert_empty_schema.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::catalogbased_changesets/V020__Create_person_name_unique.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::catalogbased_changesets/V030__Fix_person_name_constraint_CE.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::catalogbased_changesets/V030__Fix_person_name_constraint_EE.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::catalogbased_changesets/V040__Additional_stuff.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::catalogbased_changesets/V050__A_new_start.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::catalogbased_changesets/V060__Assert_final_state.xml[]
----
