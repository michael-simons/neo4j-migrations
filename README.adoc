...
[source,console,subs="verbatim,attributes"]
----
./neo4j-migrations -uneo4j -psecret --package some.migrations  --location filesystem:$HOME/Desktop/foo info
...
[source,console,subs="verbatim,attributes"]
----
./neo4j-migrations -uneo4j -psecret --package some.migrations  --location filesystem:$HOME/Desktop/foo migrate
