...
Neo4j-Migrations can be used against Neo4j 3.5, all Neo4j 4 versions from 4.1 upto 4.4 and Neo4j 5, including all current Neo4j-Aura versions.
...
For a version compatible with JDK 8, check the 1.x releases. We still do maintain the latest minor, including support for older versions of Spring Boot (prio to Spring Boot 3). This is also the versions you should be using against Neo4j 4.0.
