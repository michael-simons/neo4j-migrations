...
Migrations can be used to define a catalog in an iterative fashion. Each migration discovered will contribute to a catalog
...
[source,xml]
----
include::../neo4j-migrations-core/src/test/resources/xml/manual/V01__Create_constraints_local.xml[]
----
...
[source,xml]
----
include::../neo4j-migrations-core/src/test/resources/xml/manual/V01__Create_constraints_global.xml[]
----
...
[source,xml]
----
include::../neo4j-migrations-core/src/test/resources/xml/manual/V23__Drop_old_constraint.xml[]
----
...
+
TODO Explain retries (not doing on 3.5 and 4.0)
