...
class QueryRunnerTest {
	...
	class QueryRunnerFeatureSet {
		...
		void withBatchingSupportShouldWork() {
			...
			QueryRunner.FeatureSet featureSet = QueryRunner.defaultFeatureSet();
			assertThat(featureSet.withBatchingSupport(featureSet.hasBatchingSupport())).isSameAs(
				featureSet);
		...
		void withElementIdSupportShouldWork() {
			...
			QueryRunner.FeatureSet featureSet = QueryRunner.defaultFeatureSet();
			assertThat(featureSet.withElementIdSupport(featureSet.hasElementIdSupport())).isSameAs(
				featureSet);
		...
		void withRequiredVersionShouldWork() {
			...
			QueryRunner.FeatureSet featureSet = QueryRunner.defaultFeatureSet();
			assertThat(featureSet.withRequiredVersion(featureSet.requiredVersion())).isSameAs(
				featureSet);
