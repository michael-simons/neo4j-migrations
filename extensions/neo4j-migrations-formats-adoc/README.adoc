...
----
dependencies {
    implementation '{groupId}:{artifactIdFormatAdoc}:{version}'
}
----

And that's all.

For the CLI, you should download the `-all` artifact from Maven Central: https://repo.maven.apache.org/maven2/eu/michael-simons/neo4j/neo4j-migrations-formats-adoc/{version}/neo4j-migrations-formats-adoc-{version}-all.jar[neo4j-migrations-formats-adoc-{version}-all.jar]
...
curl -LO https://repo.maven.apache.org/maven2/eu/michael-simons/neo4j/neo4j-migrations-formats-adoc/{version}/neo4j-migrations-formats-adoc-{version}-all.jar
unzip neo4j-migrations-{version}.zip
cd neo4j-migrations-{version}
CLASSPATH_PREFIX=../neo4j-migrations-formats-adoc-{version}-all.jar \
