...
----
include::example$V01__Create_constraints_local.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$V01__Create_constraints_global.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$V23__Drop_old_constraint.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$V01__Create_an_index_local.xml[]
----
...
[source,xml,indent=0,tabsize=2]
----
include::example$V42__Rename_labels.xml[]
----
