...
import ac.simons.neo4j.migrations.Discoverer.CypherBasedMigrationDiscoverer;
import ac.simons.neo4j.migrations.Discoverer.JavaBasedMigrationDiscoverer;
...
class DiscovererTest {
	...
	class JavaBasedMigrationDiscovererTest {
		...
		void shouldFindMigrations() {
			...
			MigrationContext context = new DefaultMigrationContext(
				MigrationsConfig.builder().withPackagesToScan(
					"ac.simons.neo4j.migrations.test_migrations.changeset1").build(), Mockito.mock(Driver.class));
		...
		void shouldFindStaticInnerClasses() {
			...
			MigrationContext context = new DefaultMigrationContext(
				MigrationsConfig.builder().withPackagesToScan(
					"ac.simons.neo4j.migrations.test_migrations.changeset3").build(), Mockito.mock(Driver.class));
